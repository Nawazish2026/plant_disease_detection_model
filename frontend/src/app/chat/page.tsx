...
export default function ChatPage() {
  ...
  return (
    <div className="min-h-screen animated-bg">
      <div className="container mx-auto max-w-3xl px-4 pt-6 pb-32">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-emerald-500/10" style={{ backgroundColor: 'rgba(6,13,9,0.95)', backdropFilter: 'blur(20px)' }}>
